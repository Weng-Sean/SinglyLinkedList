public interface CSE214List<T>{
     ...
     * Throws {@link java.util.NoSuchElementException} if such an element is not present * in this list.
     * @param elem the given element
     */
    void remove(T elem);
    /**
     * Searches for the specified element in this list, and returns <code>true</code> if * and only if it was found.
     * @param elem the specified element
